...
KShape * KoPADocumentModel::childFromIndex(KoShapeContainer *parent, int row) const
{
...
int KoPADocumentModel::indexFromChild(KoShapeContainer *parent, KShape *child) const
{
    if (!m_document)
        return 0;
