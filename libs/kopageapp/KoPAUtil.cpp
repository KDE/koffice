...
void KoPAUtil::setZoom(const KOdfPageLayoutData &pageLayout, const QSize &size, KoZoomHandler &zoomHandler)
{
...
QRect KoPAUtil::pageRect(const KOdfPageLayoutData &pageLayout, const QSize &size, const KoZoomHandler &zoomHandler)
{
