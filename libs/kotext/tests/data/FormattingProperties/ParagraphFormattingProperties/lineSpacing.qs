...
setFormatProperty(textBlockFormat1, KParagraphStyle.FixedLineHeight, 72 * 0.5);
...
setFormatProperty(textBlockFormat2, KParagraphStyle.PercentLineHeight, 200);
...
setFormatProperty(textBlockFormat3, KParagraphStyle.MinimumLineHeight, 72 * 0.5);
...
setFormatProperty(textBlockFormat4, KParagraphStyle.LineSpacing, 72 * 0.5);
...
setFormatProperty(textBlockFormat5, KParagraphStyle.LineSpacingFromFont, true);
