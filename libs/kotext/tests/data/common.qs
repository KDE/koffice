...
// Default font - See KTextShapeData constructor
...
KTableCellStyle.StyleId = i++,
KTableCellStyle.TopBorderOuterPen = i++;
KTableCellStyle.TopBorderSpacing = i++;
KTableCellStyle.TopBorderInnerPen = i++;
KTableCellStyle.LeftBorderOuterPen = i++;
KTableCellStyle.LeftBorderSpacing = i++;
KTableCellStyle.LeftBorderInnerPen = i++;
KTableCellStyle.BottomBorderOuterPen = i++;
KTableCellStyle.BottomBorderSpacing = i++;
KTableCellStyle.BottomBorderInnerPen = i++;
KTableCellStyle.RightBorderOuterPen = i++;
KTableCellStyle.RightBorderSpacing = i++;
KTableCellStyle.RightBorderInnerPen = i++;
KTableCellStyle.CellBackgroundBrush = i++;
KTableCellStyle.MasterPageName = i++;
KTableCellStyle.InlineRdf = i++;       
