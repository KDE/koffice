...
#ifndef KPATHSEGMENTCHANGESTRATEGY_H
#define KPATHSEGMENTCHANGESTRATEGY_H
...
{
public:
    KPathSegmentChangeStrategy(KPathTool *tool, const QPointF &pos, const KPathPointData &segment, qreal segmentParam);
