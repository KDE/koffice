...
#include "KCreateShapesToolFactory_p.h"
...
KCreateShapesToolFactory::~KCreateShapesToolFactory()
{
}

KoToolBase* KCreateShapesToolFactory::createTool(KCanvasBase *canvas)
{
