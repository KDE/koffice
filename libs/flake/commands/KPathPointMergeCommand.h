...
class FLAKE_EXPORT KPathPointMergeCommand : public QUndoCommand
{
public:
    /**
     ...
     */
    KPathPointMergeCommand(const KPathPointData &pointData1, const KPathPointData &pointData2, QUndoCommand *parent = 0);
    ~KPathPointMergeCommand();
