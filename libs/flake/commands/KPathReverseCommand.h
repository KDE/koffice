...
#ifndef KPATHREVERSECOMMAND_H
#define KPATHREVERSECOMMAND_H
...
public:
     ...
     */
    explicit KPathReverseCommand(const QList<KPathShape*> &paths, QUndoCommand *parent = 0);
