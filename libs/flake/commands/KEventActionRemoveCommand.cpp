...
{
public:
    KEventActionRemoveCommandPrivate(KShape *s, KEventAction *e)
...
KEventActionRemoveCommand::KEventActionRemoveCommand(KShape *shape, KEventAction *eventAction, QUndoCommand *parent)
    : QUndoCommand(parent),
