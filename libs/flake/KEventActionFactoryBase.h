...
#ifndef KEVENTACTIONFACTORY_H
#define KEVENTACTIONFACTORY_H
...
public:
     ...
     */
    explicit KEventActionFactoryBase(const QString &id, const QString & action = QString());
    virtual ~KEventActionFactoryBase();
