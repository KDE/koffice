...
void TestRemoveSubpathCommand::redoUndo()
{
    ...
    QUndoCommand *cmd1 = new KSubpathRemoveCommand(&path, 0);
    cmd1->redo();
    ...
    QUndoCommand *cmd2 = new KSubpathRemoveCommand(&path, 1);
    cmd2->redo();
    ...
    QUndoCommand *cmd3 = new KSubpathRemoveCommand(&path, 2);
    cmd3->redo();
