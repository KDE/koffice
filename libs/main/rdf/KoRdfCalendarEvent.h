...
public:
    explicit KoRdfCalendarEvent(QObject *parent, KoDocumentRdf *m_rdf = 0);
    ...
    virtual void importFromData(const QByteArray& ba, KoDocumentRdf *m_rdf = 0, KCanvasBase *host = 0);
