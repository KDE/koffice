...
bool CellToolBase::Private::formatKeyPress(QKeyEvent * _ev)
{
    ...
    case Qt::Key_Ampersand:
        ...
        command->setTopBorderPen(QPen(q->canvas()->resourceManager()->foregroundColor(), 1, Qt::SolidLine));
        command->setBottomBorderPen(QPen(q->canvas()->resourceManager()->foregroundColor(), 1, Qt::SolidLine));
        command->setLeftBorderPen(QPen(q->canvas()->resourceManager()->foregroundColor(), 1, Qt::SolidLine));
        command->setRightBorderPen(QPen(q->canvas()->resourceManager()->foregroundColor(), 1, Qt::SolidLine));
        break;
