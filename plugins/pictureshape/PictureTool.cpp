...
void PictureTool::activate(ToolActivation toolActivation, const QSet<KShape*> &shapes)
{
...
void PictureTool::setImageData(KJob *job)
{
    ...
    KImageData *data = m_pictureshape->imageCollection()->createImageData(transferJob->data());
