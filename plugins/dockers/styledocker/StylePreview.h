...
public:
     ...
     */
    void update(KoShapeBorderBase * stroke, KoShapeBackground * fill);
...
signals:
    ...
    void strokeChanged(const KoShapeBorderBase &);
...
private:
    ...
    void drawStroke(QPainter & painter, const KoShapeBorderBase*);
