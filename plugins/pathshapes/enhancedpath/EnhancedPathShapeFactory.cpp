...
EnhancedPathShapeFactory::EnhancedPathShapeFactory(QObject *parent)
    : KShapeFactoryBase(parent, EnhancedPathShapeId, i18n("An enhanced path shape"))
{
...
KShape *EnhancedPathShapeFactory::createDefaultShape(KResourceManager *) const
{
...
KShape *EnhancedPathShapeFactory::createShape(const KProperties *params, KResourceManager *) const
{
...
bool EnhancedPathShapeFactory::supports(const KXmlElement & e, KoShapeLoadingContext &context) const
{
    Q_UNUSED(context);
