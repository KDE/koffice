...
#ifndef KWFRAMEREMOVESILENTCOMMAND_H
#define KWFRAMEREMOVESILENTCOMMAND_H
...
class KWFrameRemoveSilentCommand : public QUndoCommand
{
public:
    /**
     ...
     */
    explicit KWFrameRemoveSilentCommand(KWDocument *doc, KWFrame *frame, QUndoCommand *parent = 0);
    ~KWFrameRemoveSilentCommand();
