...
public:
     ...
     */
    KarbonLayerReorderCommand(KarbonDocument* document, KShapeLayer* layer, ReorderType commandType, QUndoCommand* parent = 0);
     ...
     * @param commandType the type of the command to redo
     */
    KarbonLayerReorderCommand(KarbonDocument* document, QList<KShapeLayer*> layers, ReorderType commandType, QUndoCommand* parent = 0);
