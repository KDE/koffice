...
#ifndef SCPLACEHOLDER_H
#define SCPLACEHOLDER_H
...
public:
     ...
     *
     * as OO uses absolute values and in showcase we use relative values for the placeholders
