...
public:
     ...
     * cache initially. Everyone else should just ask with @value for the value they want.
     *
     * @param textBlockData The KTextBlockData which the value is set on
     * @param id The id of the value we are asking if is set
     * @return true if the value is already set.
     */
    bool hasValue(int step, KTextBlockData *textBlockData, const QString &id);
     ...
     * @param value The value is should have
     */
    void setValue(int step, KTextBlockData *textBlockData, const QString &id, const QVariant &value);
     ...
     * @return the value as a QVariant
     */
    QVariant value(KTextBlockData *textBlockData, const QString &id, const QVariant &defaultValue);
    ...
    void init(int step, KShape *shape, KTextBlockData * textBlockData, const QString &id, const QVariant &value);
    ...
    void update(KShape *shape, KTextBlockData * textBlockData, const QString &id, const QVariant &value);
...
private:
    ...
    QList<QMap<KTextBlockData *, QMap<QString, QVariant> > > m_textBlockDataValuesStack;
    QMap<KShape *, QMap<QString, QVariant> > m_currentShapeValues;
    QMap<KTextBlockData *, QMap<QString, QVariant> > m_currentTextBlockDataValues;
    int m_step;
    bool m_next;
    QSizeF m_pageSize;
    qreal m_zoom;
