...
#ifndef SCSPACEROTATIONFROMRIGHTSTRATEGY_H
#define SCSPACEROTATIONFROMRIGHTSTRATEGY_H

#include "pageeffects/SCPageEffectStrategy.h"
#include <QTransform>

class SCSpaceRotationFromRightStrategy : public SCPageEffectStrategy
{
public:
    SCSpaceRotationFromRightStrategy();
    virtual ~SCSpaceRotationFromRightStrategy();
...
#endif // SCSPACEROTATIONFROMRIGHTSTRATEGY_H
