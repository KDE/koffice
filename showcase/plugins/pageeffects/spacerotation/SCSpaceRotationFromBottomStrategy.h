...
#ifndef SCSPACEROTATIONFROMBOTTOMSTRATEGY_H
#define SCSPACEROTATIONFROMBOTTOMSTRATEGY_H

#include "pageeffects/SCPageEffectStrategy.h"
#include <QTransform>

class SCSpaceRotationFromBottomStrategy : public SCPageEffectStrategy
{
public:
    SCSpaceRotationFromBottomStrategy();
    virtual ~SCSpaceRotationFromBottomStrategy();
...
#endif // SCSPACEROTATIONFROMBOTTOMSTRATEGY_H
