...
DiagonalWipeStrategy::DiagonalWipeStrategy(int subtype, const char *smilSubType, bool reverse)
    : SCPageEffectStrategy(subtype, "diagonalWipe", smilSubType, reverse)
{
}
...
void DiagonalWipeStrategy::setup(const SCPageEffect::Data &data, QTimeLine &timeLine)
{
    Q_UNUSED(data);
    timeLine.setFrameRange(0, StepCount);
}

void DiagonalWipeStrategy::paintStep(QPainter &p, int currPos, const SCPageEffect::Data &data)
{
...
void DiagonalWipeStrategy::next(const SCPageEffect::Data &data)
{
