...
BoxWipeStrategy::BoxWipeStrategy(int subtype, const char *smilSubType, bool reverse)
    : SCPageEffectStrategy(subtype, "boxWipe", smilSubType, reverse)
{
}
...
void BoxWipeStrategy::setup(const SCPageEffect::Data &data, QTimeLine &timeLine)
{
    Q_UNUSED(data);
    timeLine.setFrameRange(0, StepCount);
}

void BoxWipeStrategy::paintStep(QPainter &p, int currPos, const SCPageEffect::Data &data)
{
...
void BoxWipeStrategy::next(const SCPageEffect::Data &data)
{
