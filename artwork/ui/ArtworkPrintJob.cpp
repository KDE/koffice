...
ArtworkPrintJob::ArtworkPrintJob(ArtworkView *view)
...
QRectF ArtworkPrintJob::preparePage(int)
{
...
QList<KShape*> ArtworkPrintJob::shapesOnPage(int)
{
    return shapeManager()->shapes();
}

QList<QWidget*> ArtworkPrintJob::createOptionWidgets() const
{
