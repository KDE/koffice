...
#ifndef ARTWORKLAYERMODEL_H
#define ARTWORKLAYERMODEL_H
...
class ArtworkLayerModel : public KoDocumentSectionModel
{
    Q_OBJECT

public:
    /// Constructs a new layer model using the specified documents data
    ArtworkLayerModel(QObject * parent = 0);
