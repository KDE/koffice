...
#ifndef ARTWORKZOOMCONTROLLER_H
#define ARTWORKZOOMCONTROLLER_H
...
class ArtworkZoomController : public QObject
{
    Q_OBJECT
public:
    /**
     ...
     */
    ArtworkZoomController(KCanvasController *controller, KActionCollection *actionCollection, QObject *parent = 0);

    /// destructor
    ~ArtworkZoomController();
