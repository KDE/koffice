...
#ifndef ARTWORKCANVAS_H
#define ARTWORKCANVAS_H
...
class ArtworkCanvas: public QWidget, public KCanvasBase
{
    Q_OBJECT

public:
    explicit ArtworkCanvas(ArtworkPart *p);
    virtual ~ArtworkCanvas();
...
private:
    ...
    class ArtworkCanvasPrivate;
    ArtworkCanvasPrivate * const d;
};

#endif // ARTWORKCANVAS_H
