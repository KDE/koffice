...
#ifndef ARTWORKPATTERNOPTIONSWIDGET_H
#define ARTWORKPATTERNOPTIONSWIDGET_H
...
class ARTWORKUI_EXPORT ArtworkPatternOptionsWidget : public QWidget {
    Q_OBJECT
public:
    ArtworkPatternOptionsWidget(QWidget * parent = 0);
    virtual ~ArtworkPatternOptionsWidget();
...
#endif // ARTWORKPATTERNOPTIONSWIDGET_H
