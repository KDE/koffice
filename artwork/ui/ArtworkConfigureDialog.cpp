...
ArtworkConfigureDialog::ArtworkConfigureDialog(ArtworkView* parent)
        : KPageDialog(parent)
{
    setFaceType(List);
...
void ArtworkConfigureDialog::slotApply()
{
...
void ArtworkConfigureDialog::slotDefault()
{
...
ConfigInterfacePage::ConfigInterfacePage(ArtworkView* view, char* name)
{
    setObjectName(name);

    m_view = view;
    m_config = ArtworkFactory::componentData().config();
...
#include "ArtworkConfigureDialog.moc"
