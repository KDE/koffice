...
#ifndef ARTWORKPENCILTOOL_H
#define ARTWORKPENCILTOOL_H
...
class ArtworkPencilTool : public KToolBase
{
    Q_OBJECT
public:
    explicit ArtworkPencilTool(KCanvasBase *canvas);
    ~ArtworkPencilTool();
