...
#ifndef ARTWORKFILTEREFFECTSTOOL_H
#define ARTWORKFILTEREFFECTSTOOL_H
...
class ArtworkFilterEffectsTool : public KInteractionTool
{
    Q_OBJECT
public:
    enum EditMode {
    ...
    explicit ArtworkFilterEffectsTool(KCanvasBase *canvas);
    virtual ~ArtworkFilterEffectsTool();
...
#endif // ARTWORKFILTEREFFECTSTOOL_H
