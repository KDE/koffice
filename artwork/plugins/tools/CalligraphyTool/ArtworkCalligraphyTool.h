...
#ifndef ARTWORKCALLIGRAPHYTOOL_H
#define ARTWORKCALLIGRAPHYTOOL_H
...
class KShapeGroup;
class KPathPoint;
class ArtworkCalligraphicShape;
class ArtworkCalligraphyOptionWidget;

class ArtworkCalligraphyTool : public KToolBase
{
    Q_OBJECT
public:
...
private:
    ...
    QPointF m_lastPoint;
    ArtworkCalligraphicShape *m_shape;
    ...
    ArtworkCalligraphicShape *m_lastShape;
};

#endif // ARTWORKCALLIGRAPHYTOOL_H
