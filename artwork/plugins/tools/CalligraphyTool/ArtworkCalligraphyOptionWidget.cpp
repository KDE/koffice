...
/*
Profiles are saved in artworkcalligraphyrc
...
const QString RCFILENAME = "artworkcalligraphyrc";
...
/*void ArtworkCalligraphyOptionWidget::customProfile()
{
...
void ArtworkCalligraphyOptionWidget::updateCurrentProfile()
{
    if (! m_changingProfile)
        saveProfile("Current");
}

void ArtworkCalligraphyOptionWidget::saveProfileAs()
{
    QString name;
...
void ArtworkCalligraphyOptionWidget::toggleUseAngle(bool checked)
{
    m_angleBox->setEnabled(! checked);
}

void ArtworkCalligraphyOptionWidget::increaseWidth()
{
    m_widthBox->setValue(m_widthBox->value() + 1);
}

void ArtworkCalligraphyOptionWidget::decreaseWidth()
{
    m_widthBox->setValue(m_widthBox->value() - 1);
}

void ArtworkCalligraphyOptionWidget::increaseAngle()
{
    m_angleBox->setValue((m_angleBox->value() + 3) % 180);
}

void ArtworkCalligraphyOptionWidget::decreaseAngle()
{
    m_angleBox->setValue((m_angleBox->value() - 3) % 180);
}
...
int ArtworkCalligraphyOptionWidget::profilePosition(const QString &profileName)
{
    int res = 0;
    ProfileMap::const_iterator it = m_profiles.constBegin();
    ProfileMap::const_iterator lastIt = m_profiles.constEnd();
...
void ArtworkCalligraphyOptionWidget::setUsePathEnabled(bool enabled)
{
