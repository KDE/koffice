...
#ifndef ARTWORKCALLIGRAPHICSHAPE_H
#define ARTWORKCALLIGRAPHICSHAPE_H

#include <KParameterShape.h>

#define ArtworkCalligraphicShapeId "ArtworkCalligraphicShape"

class ArtworkCalligraphicPoint
{
public:
    ArtworkCalligraphicPoint(const QPointF &point, qreal angle, qreal width)
...
/*class ArtworkCalligraphicShape::Point
{
public:
...
//        0--1--2--3
class ArtworkCalligraphicShape : public KParameterShape
{
public:
    ArtworkCalligraphicShape(qreal caps = 0.0);
    ~ArtworkCalligraphicShape();

    void appendPoint(const QPointF &p1, qreal angle, qreal width);
    void appendPointToPath(const ArtworkCalligraphicPoint &p);
...
private:
    ...
    QList<ArtworkCalligraphicPoint *> m_points;
    bool m_lastWasFlip;
    qreal m_caps;
};

#endif // ARTWORKCALLIGRAPHICSHAPE_H
