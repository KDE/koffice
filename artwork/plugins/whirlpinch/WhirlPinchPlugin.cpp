...
K_EXPORT_PLUGIN(WhirlPinchPluginFactory("artworkwhirlpinchplugin"))
...
void WhirlPinchPlugin::slotWhirlPinch()
{
    ...
    canvasController->canvas()->addCommand(
        new ArtworkWhirlPinchCommand(path, m_whirlPinchDlg->angle(), m_whirlPinchDlg->pinch(), m_whirlPinchDlg->radius()));
}
