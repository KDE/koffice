...
ArtworkOutlinePaintingStrategy::ArtworkOutlinePaintingStrategy(KShapeManager * shapeManager)
...
ArtworkOutlinePaintingStrategy::~ArtworkOutlinePaintingStrategy()
{
    delete m_border;
}

void ArtworkOutlinePaintingStrategy::paint(KShape * shape, QPainter &painter, const KViewConverter &converter, bool)
{
    painter.save();
