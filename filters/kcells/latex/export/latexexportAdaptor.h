...
class KCellsLatexExportDiaImpl;

class LatexExportAdaptor: public QDBusAbstractAdaptor
{
    Q_OBJECT
    Q_CLASSINFO("D-Bus Interface", "org.kde.koffice.filter.kcells.latex")

public:
    LatexExportAdaptor(KCellsLatexExportDiaImpl* dia);
...
private:
    KCellsLatexExportDiaImpl* _dialog;
};
