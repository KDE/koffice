...
namespace OoUtils
{
QString expandWhitespace(const KXmlElement& tag);
...
// From style:text-underline to kword/showcase's underline/underlinestyleline
...
// to kword/showcase's value/relativetextsize
