...
public:
    ...
    virtual void writeStyles(KOdfGenericStyles& styles, KOdfGenericStyle *graphicStyle, QColor color) = 0;
...
{
public:
    void writeStyles(KOdfGenericStyles& styles, KOdfGenericStyle *graphicStyle, QColor color);
