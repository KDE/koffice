...
#ifndef ARTWORK_1X_IMPORT_H
#define ARTWORK_1X_IMPORT_H
...
class ArtworkImport : public KoFilter
{
    Q_OBJECT

public:
    ArtworkImport(QObject* parent, const QVariantList&);
    virtual ~ArtworkImport();
...
private:
    ArtworkDocument * m_document;
    QTransform m_mirrorMatrix;
};

#endif // ARTWORK_IMPORT_H
